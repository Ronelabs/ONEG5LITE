...
class BasePlugin:
    ...
    def onHeartbeat(self):
        ...
        Domoticz.Debug("Ic2 Info : {}".format(self.PowerPresent))
        ...
        self.BatteryLevel = int(sp.getoutput(cmdLEVEL))
        os.system(cmdLEVEL)
    ...
    def ResetLED(self):
        cmd1 = 'sudo pkill dsled'
        cmd2 = 'sudo dsled b off'
        cmd3 = 'sudo dsled g off'
        cmd4 = 'sudo dsled r off'
        os.system(cmd1)
        time.sleep(1)
        os.system(cmd2)
        time.sleep(1)
